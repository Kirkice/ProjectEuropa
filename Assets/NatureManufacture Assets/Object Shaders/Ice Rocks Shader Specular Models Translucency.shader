Shader "NatureManufacture Shaders/Ice/Ice Rocks Shader Specular Models Translucency"
{
	Properties
	{
		[Header(Translucency)]
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecularCustom o )
		{
			...
			float2 appendResult11_g1023 = (float2(tex2DNode17.a , tex2DNode17.g));
			float2 temp_output_4_0_g1023 = ( ( ( appendResult11_g1023 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _IceNormalScale * -1.0 ) );
			...
			float3 appendResult19_g1023 = (float3(break8_g1023.y , break8_g1023.x , temp_output_9_0_g1023));
			...
			float3 weightedAvg315 = ( ( weightedBlendVar315.x*( appendResult19_g1023 * appendResult308 ) + weightedBlendVar315.y*tanTriplanarNormal423 + weightedBlendVar315.z*( appendResult10_g1022 * appendResult307 ) )/( weightedBlendVar315.x + weightedBlendVar315.y + weightedBlendVar315.z ) );
			...
			float3 weightedBlendVar448 = BlendComponents288;
			float4 weightedAvg448 = ( ( weightedBlendVar448.x*appendResult421 + weightedBlendVar448.y*float4( 0,0,0,0 ) + weightedBlendVar448.z*appendResult420 )/( weightedBlendVar448.x + weightedBlendVar448.y + weightedBlendVar448.z ) );
			o.Translucency = weightedAvg448.xyz;
			o.Alpha = 1;
		}
