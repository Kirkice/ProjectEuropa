Shader "NatureManufacture Shaders/Ice/Ice Rocks Shader Metalic Models"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 appendResult445 = (float4(_SnowColor.r , _SnowColor.g , _SnowColor.b , _SnowSmoothness));
			...
			float4 weightedAvg332 = ( ( weightedBlendVar332.x*appendResult421 + weightedBlendVar332.y*( appendResult445 * triplanar431 ) + weightedBlendVar332.z*appendResult420 )/( weightedBlendVar332.x + weightedBlendVar332.y + weightedBlendVar332.z ) );
